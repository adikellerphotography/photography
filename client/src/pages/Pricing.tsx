              ...
              >
                ...
                >
                  <div className="absolute left-0 top-0 bottom-0 w-20 h-full">
                    ...
                    <div className="absolute left-6 top-0 w-14 h-full">
                      <div className="absolute right-0 top-0 bottom-0 w-0 h-0 border-l-[28px] border-y-[24px] border-y-transparent border-l-[#E67E00]"></div>
                    </div>
                  </div>
