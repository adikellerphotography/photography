              ...
              >
                ...
                >
                  <div className="absolute left-0 top-0 bottom-0 aspect-square h-full">
                    ...
                    <div className="absolute left-6 top-0 bottom-0 w-10 h-full overflow-hidden">
                      <div className="absolute left-0 top-0 w-full h-full bg-[#E67E00] rounded-r-full"></div>
                    </div>
                  </div>
