          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-3 max-w-6xl mx-auto">
            {getPackages().map((pkg, index) => (
              ...
              >
                ...
                >
                  <div className="absolute left-0 top-0 bottom-0 h-full w-12 flex items-center justify-center transition-all duration-300">
                    <div className="w-0 h-0 border-t-[18px] border-b-[18px] border-l-[24px] border-t-transparent border-b-transparent border-l-[#E67E00]"></div>
                  </div>
