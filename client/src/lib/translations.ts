export const translations = {
  ...
  en: {
    ...
    info: {
      ...
      sessionDescription: "Our photography sessions are carefully crafted to capture your unique personality and style. Bat/Bar Mitzvah sessions run for 3 hours with personalized scenes reflecting the celebrant's character. Family and children sessions are 1.5 hours, featuring diverse scenes and varied shooting angles. All sessions are scheduled before sunset for optimal natural lighting, with multiple scene transitions and variety through props, clothing changes, and varied poses.",
      equipmentTitle: "Equipment and Setup",
      equipmentDescription: "We use professional-grade cameras. Our carefully selected outdoor locations provide optimal natural lighting and scenic backdrops. We provide a collapsible changing room for comfort and maintain flexible shooting environments.",
      preparationTitle: "What to Bring",
      preparationDescription: "Bring multiple outfit changes with coordinating color schemes. We recommend clean, minimal prints and unified color themes. For family sessions, coordinated but not matching outfits work best. Don't forget meaningful personal accessories and props that reflect your interests and personality.",
      meetingTitle: "Meeting Details",
      meetingDescription: "We meet 15 minutes before the scheduled time for a pre-shoot consultation to discuss your vision, plan optimal shooting locations, review lighting conditions, and align expectations.",
    },
    beforeAfter: {
    ...
    sessions: {
      ...
      description: "Facebook post with selected photos from the session",
  ...
  he: {
    ...
    info: {
      ...
      sessionDescription: "הצילומים שלנו מעוצבים בקפידה כדי לתפוס את האישיות והסגנון הייחודיים שלך. צילומי בר/בת מצווה נמשכים 3 שעות עם סצנות מותאמות אישית המשקפות את אופי החוגג/ת. צילומי משפחה וילדים נמשכים שעה וחצי, עם סצנות מגוונות וזוויות צילום שונות. כל המפגשים מתוכננים לפני השקיעה לתאורה טבעית אופטימלית, עם מעברים בין סצנות ומגוון דרך אביזרים, החלפות בגדים ופוזות מגוונות.",
      equipmentTitle: "ציוד וסטאפ",
      equipmentDescription: "אנחנו משתמשים במצלמות מקצועיות. המיקומים החיצוניים שלנו נבחרים בקפידה עם תאורה טבעית אופטימלית ורקע נופי. אנו מספקים חדר הלבשה נייד לנוחות ושומרים על סביבת צילום גמישה.",
      preparationTitle: "מה להביא",
      preparationDescription: "הביאו מספר חילופי בגדים עם סכמות צבעים מתואמות. אנו ממליצים על הדפסים נקיים ומינימליים וערכות צבעים אחידות. עבור צילומי משפחה, בגדים מתואמים אך לא זהים עובדים הכי טוב. אל תשכחו אביזרים אישיים משמעותיים ופריטים המשקפים את תחומי העניין והאישיות שלכם.",
      meetingTitle: "פרטי המפגש",
      meetingDescription: "אנו נפגשים 15 דקות לפני הזמן המתוכנן להתייעצות מקדימה כדי לדון בחזון שלכם, לתכנן מיקומי צילום אופטימליים, לבחון תנאי תאורה ולתאם ציפיות.",
    },
    beforeAfter: {
    ...
    sessions: {
      title: "גלריות צילום",
      description: "פוסט בפייסבוק עם תמונות נבחרות מהמפגש",
      "Bat Mitsva": "בת מצווה",
      "Bar Mitsva": "בר מצווה",
      "Horses": "סוסים",
      "Kids": "ילדים",
