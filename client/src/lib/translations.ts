export const translations = {
  en: {
    ...
    info: {
      ...
      equipmentDescription: "We use professional-grade cameras and advanced lighting equipment. Our carefully selected outdoor locations provide optimal natural lighting and scenic backdrops. We provide a collapsible changing room for comfort and maintain flexible shooting environments.",
  ...
  he: {
    ...
    info: {
      ...
      equipmentDescription: "אנו משתמשים במצלמות מקצועיות וציוד תאורה מתקדם. המיקומים החיצוניים שלנו נבחרים בקפידה עם תאורה טבעית אופטימלית ורקע נופי. אנו מספקים חדר הלבשה נייד לנוחות ושומרים על סביבת צילום גמישה.",
